...
class Cars extends \yii\db\ActiveRecord
{
    ...
    public function veicleImage()
    {
        switch ($this->carType) {
            case 'PASSENGER CAR':
                return '
                <svg style="fill: ' . $this->color . ';" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1141.67 387.4" width="50">
...
<path d="M1197.4,496.5c.1,41.8-34,75.9-75.9,76a76,76,0,1,1,75.9-76Z" transform="translate(-222.53 -185.1)"/><path d="M426.7,420.5a76,76,0,1,1-76,76A76.12,76.12,0,0,1,426.7,420.5Z" transform="translate(-222.53 -185.1)"/>
            ...
            case 'MOTORCYCLE':
                return '
                <svg style="fill: ' . $this->color . ';" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 638.66 342.07" width="50">
                <title>' . $this->color . '</title>
            ...
            case 'TRUCK ':
                return '
                <svg style="fill: ' . $this->color . ';" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 593.77 300.84" width="50">
                <title>' . $this->color . '</title>
            ...
            case 'MULTIPURPOSE PASSENGER VEHICLE (MPV)':
                return '
                <svg style="fill: ' . $this->color . ';" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 559.05 209.07" width="50">
                <title>' . $this->color . '</title>
