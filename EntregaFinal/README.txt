...
API e Plataforma WEB - Método de Instalação
...
6 (exclusivo API) - Lançar o servidor MQTT executando o seguinte comando:
...
Importante
Todos os tipos de utilizador têm acesso às funcionalidades de Cliente. 
Na Aplicação móvel, todos os utilizadores são considerados Clientes.
